...
public abstract class BaseH2TestActivity extends BaseTemplateActivity {
    ...
    protected void connect(final CompletableListener listener) {
        /**
         * APP 认证方式实现
         * 在需要的时候初始化 IStreamSender
         */
//        String url = EnvConfig.PRE.httpsUrl;
//        String appkKey = EnvConfig.PRE.appKey;
//        String ast = EnvConfig.PRE.appSecret;
//        if (false) { // 日常
//            url = EnvConfig.DAILY_223.httpsUrl;
//            appkKey = EnvConfig.DAILY_223.appKey;
//            ast = EnvConfig.DAILY_223.appSecret;
//        }
//        final String as = ast;
//        final Profile profile = Profile.getAppKeyProfile(url, appkKey,
//                new IAuthSign() {
//                    @Override
//                    public String getSignMethod() {
//                        return AuthSignMethod.SHA1.getMethod();
//                    }
//
//                    @Override
...
//                        // hmacMd5Hex、hmacSha1Hex、hmacSha256Hex、hmacSha384Hex、hmacSha512He
//                        return AuthSignMethod.sign(AuthSignMethod.SHA1, signContent, as);
//                    }
//                });
//        client = StreamSenderFactory.streamSender(profile);
        /**
         * APP 认证方式结束
         */
