        ...
        try {
            LinkKit.getInstance().getDeviceThing().thingPropertyPost(reportData, new IPublishResourceListener() {
                ...
                public void onSuccess(String s, Object o) {
                    Log.e(TAG, "onSuccess() called with: s = [" + s + "], o = [" + o + "]");
                    showToast("设备上报状态成功");
                }

                @Override
                public void onError(String s, AError aError) {
                    Log.e(TAG, "onError() called with: s = [" + s + "], aError = [" + aError + "]");
                    showToast("设备上报状态失败");
                }
            });
        } catch (Exception e) {
    ...
    private IConnectNotifyListener connectNotifyListener = new IConnectNotifyListener() {
        ...
        public void onNotify(String connectId, String topic, AMessage aMessage) {
            ...
            if (CONNECT_ID.equals(connectId) && !TextUtils.isEmpty(topic) &&
                ...
                showToast("收到云端同步下行");
                ALog.e(TAG, "receice Message=" + new String(Base64.decodeBase64((byte[]) aMessage.data)));
                ...
                request.payloadObj = "{\"id\":\"" + resId + "\", \"code\":\"200\"" + ",\"data\":{aaaaaa} }";
//                    aResponse.data =
                LinkKit.getInstance().publish(request, new IConnectSendListener() {
                    @Override
                    public void onResponse(ARequest aRequest, AResponse aResponse) {
                        Log.e(TAG, "onResponse() called with: aRequest = [" + aRequest + "], aResponse = [" + aResponse.data + "]");
                    }
        ...
        public void onConnectStateChange(String s, ConnectState connectState) {
            Log.e(TAG, "onConnectStateChange: " + connectState);
        }
    };
    ...
    private ITResRequestHandler mCommonHandler = new ITResRequestHandler() {
        ...
        public void onProcess(String identify, Object result, ITResResponseCallback itResResponseCallback) {
            Log.e(TAG, "onProcess() called with: s = [" + identify + "], o = [" + result + "], itResResponseCallback = [" + itResResponseCallback + "]");
...
//                    outputParams.put("op", new ValueWrapper.IntValueWrapper(20));
        ...
        public void onSuccess(Object o, OutputParams outputParams) {
            Log.e(TAG, "onSuccess() called with: o = [" + o + "], outputParams = [" + outputParams + "]");
            showToast("注册服务成功");
        }

        @Override
        public void onFail(Object o, ErrorInfo errorInfo) {
            Log.e(TAG, "onFail() called with: o = [" + o + "], errorInfo = [" + errorInfo + "]");
            showToast("注册服务失败");
        }
    };
