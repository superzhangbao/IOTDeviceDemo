...
public class SubDeviceControlPannelActivity extends BaseActivity {
...
//        connect();
    ...
    private void setServiceHandler() {
        ...
        try {
            ...
            for (int i = 0; srviceList != null && i < srviceList.size(); i++) {
                ...
                thing.setServiceHandler(service.getIdentifier(), mCommonHandler);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    IConnectNotifyListener  connectNotifyListener = new IConnectNotifyListener() {
        @Override
...
//        }
                    ...
                    for (int i = 0; i < specsList.size(); i++) {
                        ...
                        if (idKey != null && dataJson.containsKey(idKey) && dataType != null){
                            ...
                            if ("int".equals(dataType)){
                                ...
                                if (isValidInt(String.valueOf(dataJson.get(i)))) {
    ...
    public void postEvent(View view) {
        ...
        try {
            ...
            thing.thingEventPost(event.getIdentifier(), params, new IPublishResourceListener() {
                @Override
                public void onSuccess(String s, Object o) {
